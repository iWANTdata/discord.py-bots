    ...
    async def on_message(self, message):
        ...
        if message.content.startswith(electionbot_prefix):
            ...
            if message.content == electionbot_prefix + ' help':
                ...
                info_embed.add_field(name="Personalize ✏:", value="You can personalize this bot by download the code from github (https://github.com/Fynnyx/discord.py-bots) and run it by yourself.", inline=True)
